...
namespace MaterialSkin.Controls
{
    public class MaterialFlatButton : Button, IMaterialControl
    {
        ...
        public MaterialFlatButton()
        {
            ...
            //AutoSize = true;
            this.BackColor = SkinManager.GetPrimaryColor();
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            double Alpha = hoverAnimationManager.GetProgress() * (c.A-200) + 200 > 255 ? 255 : hoverAnimationManager.GetProgress() * (c.A-200) + 200;
            using (Brush b = new SolidBrush(Color.FromArgb((int)(Alpha), c.RemoveAlpha())))
			...
			g.DrawString(Text,
                ...
                Enabled ? (Primary ? SkinManager.ColorScheme.PrimaryBrush : SkinManager.GetMainTextBrushRevert()) : SkinManager.GetFlatButtonDisabledTextBrush(),
