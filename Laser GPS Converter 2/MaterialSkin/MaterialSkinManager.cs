...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        private static readonly Color BACKGROUND_LIGHT = Color.FromArgb(255, 247, 247, 247);
        ...
        public Brush GetMainTextBrushRevert()
        {
            return (Theme == Themes.DARK ? MAIN_TEXT_BLACK_BRUSH : MAIN_TEXT_WHITE_BRUSH);
        }


        public Color GetPrimaryColor()
        {
            return (Theme == Themes.DARK ? colorScheme.DarkPrimaryColor : colorScheme.LightPrimaryColor);
        }
